          ...
          <div className='columns is-multiline is-justify-content-center'>
            <div className='column is-narrow has-text-centered'>
              ...
              <div className='content'>
                ...
                <p>
                  This championship is all about having fun & driving our favorite cars on the challenging simulator of
                  Richard Burns Rally.
                  <br />
                  Our purpose is to deliver the atmosphere and challenge of real rallies, to our drivers.
                </p>
                <p>
                  The main idea behind our championship is to have small seasons of 5 rallies.
                  <br />
                  Our roadbooks will consist of wide variety of car classes for our drivers to use.
                  <br />
                  Our goal is for drivers is to have fun and finish our rallies.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='column is-5 text-side order-mobile-2'>
            <div className='content'>
              ...
              <ul className='has-text-left'>
                ...
                <li>
                  Don&apos;t try to cheat because we don&apos;t care <i>for now</i>.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className='columns zig-zag is-align-items-center is-justify-content-space-between paragraph img-left'>
          ...
          <div className='column is-5 text-side'>
            <div className='content'>
              ...
              <p>
                We love to share our work with the world of social media. We also love the work of{' '}
                <a href='https://www.rallysimfans.hu/' target='_blank' rel='noreferrer'>
                  Rallysimfans.hu
                </a>{' '}
                community.
              </p>
              <p>
                In order to help the community to grow we encourage our drivers to share your <strong>photos</strong> or{' '}
                <strong>videos</strong> from our rallies on <i>Instagram / Facebook</i> and use the hashtags{' '}
                <strong>#rallydiarieseRally</strong> & <strong>#rallysimfans</strong>.
              </p>
            </div>
          </div>
        </div>
