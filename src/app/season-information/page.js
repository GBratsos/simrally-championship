      ...
      <div className='top-section'>
          ...
          <div className='columns is-justify-content-center'>
            <div className='column is-8 has-text-centered'>
              ...
              <div className='content'>
                <p>
                  RallyDiaries eRally Championship seasons, consist of{' '}
                  <strong>
                    <i>5 rallies</i>
                  </strong>{' '}
                  with 1 or 2 legs for each rally.
                </p>
                <p>There will be general and class classifications. There will be no group classification.</p>
                <p>
                  You will find all information about our current season on championship&apos;s website at{' '}
                  <a
                    href='https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=306'
                    target='_blank'
                    rel='noreferrer'
                  >
                    Rallysimfans.hu
        ...
        <section className='seasonInformation section'>
          <div className='container'>
            <div className='columns is-justify-content-center'>
              <div className='column is-8 has-text-centered'>
                <h2 className='blockTitle'>SEASON 6 CALENDAR</h2>
              </div>
            </div>
            <div className='columns is-multiline is-justify-content-center'>
              <div className='column is-5'>
                <div className='rally'>
                  <h3 className='rally-title'>RallyDiaries eRally Championship S6 Round 1</h3>
                  <p className='rally-date'>21 - 25 November 2024</p>
                </div>
              </div>
              <div className='column is-5'>
                <div className='rally'>
                  <h3 className='rally-title'>RallyDiaries eRally Championship S6 Round 2</h3>
                  <p className='rally-date'>5 - 9 December 2024</p>
                </div>
              </div>
              <div className='column is-5'>
                <div className='rally'>
                  <h3 className='rally-title'>RallyDiaries eRally Championship S6 Round 3</h3>
                  <p className='rally-date'>19 - 23 December 2024</p>
                </div>
              </div>
              <div className='column is-5'>
                <div className='rally'>
                  <h3 className='rally-title'>RallyDiaries eRally Championship S6 Round 4</h3>
                  <p className='rally-date'>02 - 06 January 2025</p>
                </div>
              </div>
              <div className='column is-5'>
                <div className='rally'>
                  <h3 className='rally-title'>RallyDiaries eRally Championship S6 Round 5</h3>
                  <p className='rally-date'>16 - 20 January 2025</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='columns'>
            <div className='column is-6'>
              <div className='result'>
                <svg width='295' height='218' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  <path
                    d='M63.31 50.509H51.7V17.005H35.03v5.052h11.619v28.452h-11.62v5.052h28.28v-5.052Z'
                    fill='#231F20'
                  />
                  <path
                    d='M295 75.081V70.03H100.866V0h-5.052v70.03H0v5.051h95.814v67.504H0v5.051h95.814v70.03h5.052v-70.03H295v-5.051H100.866V75.081H295Z'
                    fill='#231F20'
                  />
                  <path
                    d='M35 112.829v15.287h28.31v-5.052H40.051v-7.052l23.25-11.175V89.56H35v13.691h5.051v-8.64h18.197v7.053L35 112.829ZM35.02 175.805h5.052v-8.638H58.27v6.84l-11.62 4.041v6.679l11.62 4.042v6.85H40.072v-8.639H35.02v13.691h28.3v-15.489l-10.89-3.789 10.89-3.789v-15.489h-28.3v13.69Z'
                    fill='#231F20'
                  />
                </svg>
                <h3 className='resultTitle'>
                  <a
                    href='https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=306&rally_lista'
                    target='_blank'
                    rel='noreferrer'
                  >
                    SEASON STANDINGS
