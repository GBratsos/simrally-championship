export default function SeasonResultsSection() {
  return (
    <section className='seasonResultsSection section'>
      <div className='container'>
        <div className='columns is-justify-content-center'>
          <div className='column is-5 has-text-centered'>
            <h2 className='blockTitle'>RACE & FINAL RESULTS</h2>
          </div>
        </div>
        <div className='columns'>
          <div className='column'>
            <div className='result result--last-race'>
