  ...
  return (
    <section className='imageTextSection image-text-paragraph section'>
      <div className='container'>
        <div
          className='columns is-align-items-center is-justify-content-space-around paragraph img-left'
          id='partnership'
        >
          ...
          <div className='column is-5 text-side'>
            <article>
              ...
              <h3 className='img-text-title'>
                BECOME OUR <strong>PARTNER</strong> IN <strong>MOTORSPORT</strong> OR <strong>SIMRACING</strong> AND{' '}
                <strong>BENEFIT</strong> YOUR BUSINESS.
              </h3>
              <p>Contact us to discuss how we can help your business grow through motorsport or simracing.</p>
              <p className='link'>
                <a href='https://rallydiaries.eu/en/contact-us' target='_blank' rel='noreferrer' className='button'>
                  SEND A MESSAGE
                </a>
              </p>
            </article>
        ...
        <div className='columns ordered-mobile is-align-items-center is-justify-content-space-around paragraph img-right'>
          <div className='column order-mobile-2 is-5 text-side'>
            ...
            <h3 className='img-text-title'>
              OUR <strong>TEAM</strong> IS HAPPY TO HELP WITH ANYTHING REGARDING OUR eRALLY CHAMPIONSHIP.
            </h3>
            <p className='link'>
              <a href='https://rallydiaries.eu/en/contact-us' target='_blank' rel='noreferrer' className='button'>
                CONTACT US
