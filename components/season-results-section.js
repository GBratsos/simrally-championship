                        ...
                        <div className="column">
                            <div className="result result--last-race">
                                ...
                                <h3 className="resultTitle">
                                    <a href="https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=258&rally_lista" target="_blank" rel="noreferrer">LAST RACE RESULTS</a>
                                </h3>
                            </div>
                        </div>
                        <div className="column">
                            <div className="result result--final">
                                ...
                                <h3 className="resultTitle">
                                    <a href="https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=258&ponttabla" target="_blank" rel="noreferrer">FINAL RESULTS</a>
                                </h3>
                            </div>
                        </div>
                    </div>
