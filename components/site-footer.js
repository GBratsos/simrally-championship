...
import { faFacebookF, faInstagram, faYoutube, faDiscord, faTwitch, faTwitter, faViber } from '@fortawesome/free-brands-svg-icons'
                ...
                <div className="container">
                    <div className="columns is-mobile is-multiline is-align-items-center is-justify-content-space-between ordered-mobile">
                        <div className='column is-narrow order-mobile-2'>
                            <p>Copyright &copy; 2022 <strong><i><a href='https://rallydiaries.eu/en' target="_blank" rel="noreferrer">RallyDiaries</a></i></strong>.</p>
                        </div>
