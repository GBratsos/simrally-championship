                    ...
                    <div className="columns is-justify-content-center">
                        <div className="column is-8 has-text-centered">
                            ...
                            <div className="content">
                                ...
                                <p>You will find all information about our current season on championship&apos;s website at <a href="https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=200" target="_blank" rel="noreferrer">Rallysimfans.hu</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="columns">
                        ...
                        <div className="column is-6">
                            <div className="result">
                                ...
                                <h3 className="resultTitle">
                                    <a href="https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek_min&bajnoksag_id=200&ponttabla">SEASON RESULTS</a>
                                </h3>
                            </div>
                        </div>
                    </div>
