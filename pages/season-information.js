      ...
      <div className='top-section'>
          ...
          <div className='columns is-justify-content-center'>
            <div className='column is-8 has-text-centered'>
              ...
              <div className='content'>
                ...
                <p>
                  There will be general and class classifications. There will be no group
                  classification.
                </p>
                <p>
                  You will find all information about our current season on championship&apos;s
                  website at{' '}
                  <a
                    href='https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=293'
                    target='_blank'
                    rel='noreferrer'
                  >
                    Rallysimfans.hu
        ...
        <section className='seasonInformation section'>
          <div className='container'>
            <div className='columns is-justify-content-center'>
              <div className='column is-8 has-text-centered'>
                <h2 className='blockTitle'>SEASON 5 CALENDAR</h2>
              </div>
            </div>
          ...
          <div className='columns'>
            <div className='column is-6'>
              <div className='result'>
                ...
                <h3 className='resultTitle'>
                  <a
                    href='https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=293&rally_lista'
                    target='_blank'
                    rel='noreferrer'
                  >
                    SEASON STANDINGS
            ...
            <div className='column is-6'>
              <div className='result'>
                ...
                <h3 className='resultTitle'>
                  <a
                    href='https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=293&ponttabla'
                    target='_blank'
                    rel='noreferrer'
                  >
                    SEASON RESULTS
