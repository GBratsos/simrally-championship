                        ...
                        <div className="column is-6">
                            <div className="result">
                                ...
                                <h3 className="resultTitle">
                                    <a href="https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=293&rally_lista" target="_blank" rel="noreferrer">SEASON STANDINGS</a>
                                </h3>
                            </div>
                        </div>
                        <div className="column is-6">
                            <div className="result">
                                ...
                                <h3 className="resultTitle">
                                    <a href="https://www.rallysimfans.hu/rbr/bajnoksag2.php?b=reszletek&bajnoksag_id=293&ponttabla" target="_blank" rel="noreferrer">SEASON RESULTS</a>
                                </h3>
                            </div>
                        </div>
                    </div>
